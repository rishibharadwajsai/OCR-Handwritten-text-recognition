...
const Navbar = () => {
    const links = [
        { name: "Home", link: "/" },
        { name: "Working", link: "/" }, // Change the link as needed
        { name: "Team", link: "/" }, // Change the link as needed
    ];
            ...
            <div className='md:flex items-center justify-between bg-sky-200 py-4 md:px-10 px-7'>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${isOpen ? 'top-20 opacity-100' : 'top-[-490px]'} md:opacity-100 opacity-0`}>
                    ...
                    <li className='md:ml-8 text-lg md:my-0 my-6'>
                        <Link to='/board2' className='text-gray-800 hover:text-gray-400 duration-500'>Board2</Link>
                    </li>
                    <li className='md:ml-8 text-lg md:my-0 my-6'>
                        <Link to='/tesseract' className='text-gray-800 hover:text-gray-400 duration-500'>TesseractOCR</Link>
                    </li>
                    <Button>
                        Get Started
                    </Button>
